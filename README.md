...
Interfaz gráfica moderna con diseño premium, efectos visuales y animaciones suaves. Juega directamente en tu navegador sin necesidad de instalación.
...
- 🎯 Interfaz intuitiva con clicks

### 💻 Versión Consola
Implementación clásica en Ruby para la terminal, perfecta para puristas de la línea de comandos.
...
1. Abre el archivo `index.html` en tu navegador:
   ...
   - **Opción 2**: Desde PowerShell:
     ...
     ```
   - **Opción 3**: Arrastra `index.html` a tu navegador

2. Selecciona el modo de juego:
   - Click en **"Dos Jugadores"** para modo PvP
   - Click en **"Vs Computadora"** para jugar contra la IA

3. Si elegiste IA, selecciona la dificultad:
   - **Fácil** 😊: Movimientos aleatorios
   - **Medio** 😐: Bloquea y ataca
   - **Difícil** 😈: IA invencible (Minimax)

4. Haz click en las celdas vacías para jugar

5. Usa los botones:
   - **🔄 Nuevo Juego**: Reinicia el tablero
   - **⚙️ Cambiar Modo**: Vuelve al menú principal
...
### Versión Consola
- **Ruby**: Implementación completa del juego
  - Programación orientada a objetos
  - Algoritmo Minimax
...
├── script.js           # Lógica del juego web
├── triki.rb            # Versión consola en Ruby
